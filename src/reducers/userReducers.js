...
export const userUpdateProfileReducer = (state = {}, action) => {
    switch (action.type) {
        ...
        case USER_UPDATE_PROFILE_SUCCESS:
            return { loading: false, success: true, success_message: action.payload.message }
...
export const userPasswordResetReducer = (state = {}, action) => {
    switch (action.type) {
        ...
        case USER_PASSWORDRESET_SUCCESS:
            return { loading: false, success: true, success_message: action.payload.status }
...
export const userPasswordResetConfirmReducer = (state = {}, action) => {
    switch (action.type) {
        case USER_PASSWORDRESETCONFIRM_REQUEST:
            return { loading: true }

        case USER_PASSWORDRESETCONFIRM_SUCCESS:
            return { loading: false, success: true, success_message: action.payload.status }

        case USER_PASSWORDRESETCONFIRM_FAIL:
            return { loading: false, error: action.payload }
